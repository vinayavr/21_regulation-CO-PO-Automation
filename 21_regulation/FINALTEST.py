...
def index():
    ...
    # pdf_paths = [working_path + "/input/DSA-CT1-SetA.pdf", working_path + "/input/DSA-CT2-SetA.pdf",working_path + "/input/DSA-CT3-SetB.docx.pdf"]
    ...
    pdf_paths = [working_path + "/input/DSA-CT3-SetB.docx.pdf"]
    errors = COAutomation.generate_excel(pdf_paths)
