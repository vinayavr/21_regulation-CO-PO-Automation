...
downloadButton1.addEventListener("click", () => downloadExcelFile("/static/CT_Template.xlsx"));
downloadButton2.addEventListener("click", () => downloadExcelFile("/static/co_allocation.xlsx"));
